...
const Index = () => {
  ...
  const fillDummyData = () => {
    ...
    setYourCompany({
      ...
      address: "789 Oak St, Businessville, USA 54321",
      phone: "(555) 555-5555",
    ...
    setItems([
      {
        ...
        description: "Business strategy and development consultation",
        quantity: 2,
        amount: 500,
        total: 1000,
        hsn: "9983",
      ...
      },
      {
        ...
        description: "Staff training and onboarding sessions",
        quantity: 5,
        amount: 200,
        total: 1000,
        hsn: "9983",
    ...
    settaxPercentage(18);
    calculateSubTotal();
    setNotes("Thank you for choosing TechCorp Solutions! Payment terms: Net 30 days. For support, contact support@techcorp.com or call our helpline.");
  };
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-md">
          <form>
            ...
            <div className="mb-6">
              <h2 className="text-2xl font-semibold mb-4">Your Company Details</h2>
